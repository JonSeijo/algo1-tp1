...
%\aux{anchoValido}{s : Sistema}{[i\hspace{1mm}|\hspace{1mm} \selector{i}{\rangoca{0}{dameAncho(campo(s))}}]}

%\aux{largoValido}{s : Sistema}{[j\hspace{1mm}|\hspace{1mm} \selector{j}{\rangoca{0}{dameLargo(campo(s))}}]}
