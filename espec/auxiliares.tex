...
\aux{maximoUnDroneEnVuelo}{s : Sistema}{Bool}{sinRepetidos(posicionesEnY(dronesVolando(s)))}


\aux{dronesVolando}{s : Sistema}{[Drone]}{[\hspace{1mm}d\hspace{1mm}|\hspace{1mm} \selector{d}{enjambreDrones(s), \hspace{1mm} enVuelo(d)}]}