...
\asegura{(\exists \hspace{1mm} \selector{x}{enjambreDrones(s)} , \hspace{1mm} id(x) == id(d) \newline \land contenido(campo(s), prm(posicionActual(x)), sgd(posicionActual(x))) == Cultivo \newline \land estadoDelCultivo(pre(s),  prm(posicionActual(x)), sgd(posicionActual(x)) ) == NoCensado) 
\newline \implica (estadoDelCultivo(s, prm(posicionActual(x)), sgd(posicionActual(x)) )\neq NoCensado \newline \land (\forall \selector {i}{anchoValido(s)}), \hspace{1mm} \selector{j}{largoValido(s)}, \newline (i, \hspace{1mm} j) \neq posicionActual(x) , \hspace{2mm} contenido(campo(s)\hspace{1mm}, i,\hspace{1mm} j) == Cultivo  \newline \hspace{3mm} estadoDelCultivo(s,\hspace{1mm} i,\hspace{1mm}j) == estadoDelCUltivo(pre(s),\hspace{1mm}i,\hspace{1mm}j)
\newline \land bateria(x) == bateria(d) - 1 \newline \land mismos(prodctosDisponibles(x),\hspace{1mm} productosDisponibles(d)) )}

\asegura{(\exists \selector{x}{enjambreDrones(s)}, \hspace{1mm} id(x) == id(d) \newline \hspace{5mm} \land siLlegoAMaleza(x, pre(s)) \land siTieneAlgunHerbicida(d) \land bateria(x) \geq 6 ) \newline \hspace{3mm} \implica ((|productosDisponible(x)| == |productosDisponibles(d)|-1) \newline \hspace{2cm} \land (\exists \selector{p}{productosDisponibles(d)}, esHerbicida(d)) \newline \hspace{5mm} p \notin productosDisponibles(x) \land \newline \hspace{2cm} mismos(productosDisponibles(d), p : productosDisponibles(x)) \newline \hspace{3mm} \land bateria(x) == (bateria(d) - gastoBateria(p) - 1) \newline \land (\forall \selector{i}{anchoValido(s)}), \selector{j}{largoValido(s)}, (i, \hspace{1mm}j) \notin posicionesHerbizar(p, \hspace{1mm} posicionActual(x)), \newline estadoDelCultivo(s,\hspace{1mm} i ,\hspace{1mm}j) == estadoDelCultivo(pre(s)),\hspace{1mm}i,\hspace{1mm}j) \newline \land (\forall \selector{z}{posicionesHerbizar(p, posicionActual(x))}) \newline estadoDelCultivo(s,\hspace{1mm}prm(z),\hspace{1mm} sgd(z)) == RecienSembrado)}

\asegura{(\exists \selector{x}{enjambreDrones(s)}, \hspace{1mm} id(x) == id(d) \newline \hspace{5mm} \land siLlegoAPlaga(x, pre(s)) \land tieneAlgunPlaguicida(d) \land bateria(x) \geq 11 ) \newline \hspace{3mm} \implica (|productosDisponible(x)| == |productosDisponibles(d)|-1) \newline \hspace{2cm} \land (\exists \selector{p}{productosDisponibles(d)}, esPlaguicida(d)\newline \hspace{5mm} p \notin productosDisponibles(x) \land \newline \hspace{2cm} mismos(productosDisponibles(d), p : productosDisponibles(x)) \newline \hspace{3mm} \land bateria(x) == (bateria(d) - gastoBateria(p) - 1) \newline \land (\forall \selector{i}{anchoValido(s)}), \selector{j}{largoValido(s)}, (i, \hspace{1mm}j) \neq posicionActual(x), \newline estadoDelCultivo(s,\hspace{1mm} i ,\hspace{1mm}j) == estadoDelCultivo(pre(s)),\hspace{1mm}i,\hspace{1mm}j) \newline \land estadoDelCultivo(s, \hspace{1mm} prm(posicionActual(x)),\hspace{1mm} sgd(posicionActual(x))) == RecienSembrado  ) }


\asegura{(\exists \selector{x}{enjambreDrones(s)}, \hspace{1mm} id(x) == id(d) \newline \hspace{5mm} \land siLlegoAPlaga(x, pre(s)) \land tienePlaguicidaBajoConsumo(d) \land bateria(x) \geq 6 \land bateria(x) \leq 10  ) \newline \hspace{3mm} \implica (|productosDisponible(x)| == |productosDisponibles(d)|-1) \newline \hspace{2cm} \land (\exists \selector{p}{productosDisponibles(d)}, PlaguicidaBajoConsumo == p\newline \hspace{5mm} p \notin productosDisponibles(x) \land \newline \hspace{2cm} mismos(productosDisponibles(d), p : productosDisponibles(x)) \newline \hspace{3mm} \land bateria(x) == (bateria(d) - gastoBateria(p) - 1) \newline \land (\forall \selector{i}{anchoValido(s)}), \selector{j}{largoValido(s)}, (i, \hspace{1mm}j) \neq posicionActual(x), \newline estadoDelCultivo(s,\hspace{1mm} i ,\hspace{1mm}j) == estadoDelCultivo(pre(s)),\hspace{1mm}i,\hspace{1mm}j) \newline \land estadoDelCultivo(s, \hspace{1mm} prm(posicionActual(x)),\hspace{1mm} sgd(posicionActual(x))) == RecienSembrado  ) }


\asegura{(\forall \selector{x}{enjambreDrones(s)}, \hspace{1mm} id(x) == id(d),\newline \neg ( (quiereHerbizar(s, pre(s),x)) \lor(quierePlaguizar(s, pre(s),x)) \lor(quierePlaguizarBajoConsumo(s, pre(s),x)) \lor(sinCensar(s, pre(s),x)) )) \newline \implica bateria(x) == bateria(d) - 1 \newline \land mismos(productosDisponibles(x), productosCisponibles(d))}
